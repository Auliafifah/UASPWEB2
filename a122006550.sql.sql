...
CREATE TABLE `krs` (
  ...
  `idMatkul` varchar(10) DEFAULT NULL,
  `nilai` varchar(1) DEFAULT NULL,
  `nppDos` varchar(16) DEFAULT NULL,
  `hari` varchar(10) DEFAULT NULL,
  `waktu` varchar(13) DEFAULT NULL,
  `totalsks` int(12) NOT NULL
...
INSERT INTO `krs` (`idKrs`, `thAkd`, `nim`, `idMatkul`, `nilai`, `nppDos`, `hari`, `waktu`, `totalsks`) VALUES
(4, 2022, 'A12.2016.06428', 'A12.56201', 'A', '0686.11.1997.136', 'Senin', '07.00-08.40', 10),
(7, 2025, 'A12.2016.02900', 'A12.56201', 'A', '0686.11.1997.136', 'Senin', '07.00-08.40', 10),
(9, 2020, 'A12.2016.06428', 'A12.56202', 'B', '0686.11.2000.241', 'Senin', '07.00-08.40', 10);
...
CREATE TABLE `krsdetail` (
  `idkrsdetail` int(225) NOT NULL,
  `idkrs` int(225) NOT NULL,
  `id_kultawar` int(11) NOT NULL,
  `id_matkul` varchar(10) NOT NULL,
  `hari` varchar(10) NOT NULL,
  `jamkul` varchar(11) NOT NULL,
  `sks` int(2) NOT NULL,
  `jns` varchar(8) NOT NULL,
  `totalsks` int(12) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(14, 'ASKLSDD', 'DALKHN', 'DSAKHKD', 'DAKLN', 'DSAIHK', 'ASIHKD'),
(15, 'AKHA', 'qgsuhjas', 'KHWGY', 'RTYJN', 'GN', 'GHJN');
...
(28, 'A12.2016.06428', 'Iriana Erlina Permana ', 'iriana@gmail.com', 'foto/Untitled.jpg'),
(29, 'A12.2016.02900', 'Susana Listiyani', 'susana@gmail.com', 'foto/A12.2016.02900.jpg'),
(31, 'A12.2016.02902', 'Indah Lestari', 'indah@gmail.com', 'foto/AUL.jpg'),
(32, 'A12.2017.03000', 'Maulana Ibrahim', 'maulana@yahoo.com', 'foto/A12.2017.03000.jpg'),
(33, 'A12.2017.03045', 'Cantika Putri Brahmanto', 'cancan@yahoo.com', 'foto/A12.2017.03045.jpg'),
(34, 'A12.2017.03170', 'Eko Prasetyanto', 'eek@yahoo.com', 'foto/A12.2017.03170.jpg'),
(35, 'A12.2017.05041', 'Liliana Anggita Wardani', 'lili@yahoo.com', 'foto/A12.2017.05041.jpg'),
(36, 'a12.2018.08900', 'Erna Purnamawati', 'erna@gmail.com', 'foto/a12.2018.08900.jpg'),
(37, 'a12.2018.08905', 'Bambang Lukman Hakim', 'bambang@gmail.com', 'foto/a12.2018.08905.jpg'),
(45, 'A12.2020.06550', 'AULIA NUR AFIFAHhhhhhhhhhhh', '112202006550@mhs.dinus.ac.idddddddddddd', 'foto/Daylight ; Liu Yangy');
...
--
ALTER TABLE `krs`
  MODIFY `idKrs` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `krsdetail`
--
ALTER TABLE `krsdetail`
  MODIFY `idkrsdetail` int(225) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `kultawar`
--
ALTER TABLE `kultawar`
  MODIFY `idkultawar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
