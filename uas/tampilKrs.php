...
<body>
	...
	<div class="utama">
		...
		<a href="addKrs.php?nim=<?php echo $_GET['nim']?>" class="btn btn-outline-primary">Tambah KRS</a>
		<br/>
        <div class="col-sm-12">
	...
	//jika data tidak ada
		...
		while($row=mysqli_fetch_assoc($kq)){
			...
			<tr>
                ...
                <td>
				<a class="btn btn-outline-primary btn-sm" href="editKrs.php?id=<?php echo $row['idKrs']?>">Edit</a>
				<a class="btn btn-outline-danger btn-sm" href="hpsKrs.php?id=<?php echo $row['idKrs']?>&nim=<?php echo $nim?>" id="linkHps" onclick="return confirm('Yakin dihapus nih?')">Hapus</a>
				</td>
			</tr>
			<?php 
			$no++;
