...
if (isset($_POST['cari'])){
	$cari=$_POST['cari'];
	$sql="select * from krs where nim like'%$cari%' or
						  nama like '%$cari%' or
						  email like '%$cari%'";
}else{
	$sql="select * from krsdetail";		
}
...
if (isset($_POST['cari'])){
	...
	$sql="select krs.nim, mhs.nama, krs.thAkd, krs.totalsks from krs, mhs where krs.nim = mhs.nim limit $awalData, $jmlDataPerHal";		
}
...
?>
<div class="utama">
	<h2 class="text-center">Detail Kartu Rencana Study</h2>
	<div class="text-center"><a href="prnKrssPdf.php"><span class="fas fa-print">&nbsp;Print</span></a></div>
	...
	if ($kosong){
		...
		while($row=mysqli_fetch_assoc($hasil)){
			...
			<tr>
				...
				<td><a href="tampilKrs.php?nim=<?php echo $row['nim']?>"><?php echo $row["nama"]?></a></td>
