...
<div class="utama">
	...
	<div class="text-center"><a href="prnKultawar.php"><span class="fas fa-print">&nbsp;Print</span></a></div>
	...
	<span class="float-right">
		<form action="" method="post" class="form-inline">
			...
			<input class="form-control mr-2 ml-2" type="text" name="cari" placeholder="Cari data kuliah tawar..." autofocus autocomplete="off">
		</form>
	</span>
	<br><br>
	<ul class="pagination">
			...
			if ($kosong){
				...
				while($row=mysqli_fetch_assoc($hasil)){
					...
					<tr>
						...
						<td>
							<a class="btn btn-outline-primary btn-sm" href="editTawar.php?kode=<?php echo $row["idkultawar"]?>">Edit</a>
							<a class="btn btn-outline-danger btn-sm" href="hpsTawar.php?kode=<?php echo $row["idkultawar"]?>" id="linkHps" onclick="return confirm('Yakin dihapus nih?')">Hapus</a>
						</td>
					</tr>
					<?php 
					$no++;
